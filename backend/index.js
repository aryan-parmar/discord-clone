...
const io = require('socket.io')(server, { cors: { origins: 'http://10.194.23.186:3000', credentials: true } })
...
app.use(cors({ origin: 'http://10.194.23.186:3000', credentials: true }))
app.options('*', cors())
app.use(express.json())
app.use(express.urlencoded({ extended: false }))
app.use(session({ cookie: { sameSite: 'lax' }, secret: 'ebfuygwefuy26351#$@hjbqec', resave: true, saveUninitialized: false }))
app.use(cookieParser('ebfuygwefuy26351#$@hjbqec'))
app.use(morgan('dev'))
